...
//if (count>=6){
        ...
        <center>
            ...
            <input name="Reset1" style="width: 89px; height: 33px" type="button" value="UNDO" onclick="undo()" /><input name="Submit1" style="width: 73px; height: 34px" type="button" value="OK" onclick="confirmation()"/><input name="ommit" style="width: 99px; height: 33px" type="button" value="OMISSIONS" onclick="omit()" />
