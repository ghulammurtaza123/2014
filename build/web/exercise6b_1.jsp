...
case 1:           %>
   <font color="#0099BB">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#1: Monalisa is in the right of Car ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option1" value="yes" onclick="message0(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option1" value="no" onclick="message0(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#2: <%=thr%> is on the left side of  <%=seci%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option2" value="yes" onclick="message0(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option2" value="no" onclick="message0(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#3: <%=five%> is after <%=thr%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option3" value="yes" onclick="message1(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option3" value="no" onclick="message1(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#4: <%=four%> is between <%=seci%> and <%=thr%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option4" value="yes" onclick="message2(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option4" value="no" onclick="message2(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#5: <%=seci%> is between <%=five%> and <%=thr%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option5" value="yes" onclick="message4(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option5" value="no" onclick="message4(this.value)">  No<br><br>
   </font>
<% break;
case 2:%>
<font color="#0099BB">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#1: <%=firsti%> is on the left side of  <%=seci%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option2" value="yes" onclick="message1(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option2" value="no" onclick="message1(this.value)">  No<br><br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#2: <%=thr%> is between <%=four%> and <%=five%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option1" value="yes" onclick="message0(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option1" value="no" onclick="message0(this.value)">  No<br><br>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#3: <%=five%> is on the right side of <%=four%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option4" value="yes" onclick="message3(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option4" value="no" onclick="message3(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#4: <%=four%> is between <%=seci%> and <%=thr%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option3" value="yes" onclick="message2(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option3" value="no" onclick="message2(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#5: <%=seci%> is between <%=five%> and <%=thr%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option5" value="yes" onclick="message4(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option5" value="no" onclick="message4(this.value)">  No<br><br>
   </font>
...
case 3:%>
<font color="#0099BB">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#1: <%=five%> is on the right side of <%=four%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option4" value="yes" onclick="message3(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option4" value="no" onclick="message3(this.value)">  No<br><br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#2: Fish is before Flower ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option1" value="yes" onclick="message0(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option1" value="no" onclick="message0(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#3: <%=firsti%> is on the left side of  <%=seci%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option2" value="yes" onclick="message1(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option2" value="no" onclick="message1(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#4: <%=seci%> is between <%=five%> and <%=thr%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option5" value="yes" onclick="message4(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option5" value="no" onclick="message4(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#5: <%=four%> is between <%=seci%> and <%=thr%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option3" value="yes" onclick="message2(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option3" value="no" onclick="message2(this.value)">  No<br><br>
...
default:%>
<font color="black">
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#1: <%=thr%> is between <%=four%> and <%=five%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option1" value="yes" onclick="message0(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option1" value="no" onclick="message0(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#2: <%=firsti%> is on the left side of  <%=seci%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option2" value="yes" onclick="message1(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option2" value="no" onclick="message1(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#3: <%=four%> is between <%=seci%> and <%=thr%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option3" value="yes" onclick="message2(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option3" value="no" onclick="message2(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#4: <%=five%> is on the right side of <%=four%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option4" value="yes" onclick="message3(this.value)"> Yes<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option4" value="no" onclick="message3(this.value)">  No<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<B>Q#5: <%=seci%> is between <%=five%> and <%=thr%> ?</B><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="option5" value="yes" onclick="message4(this.value)"> Yes<br>
...
<center>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 <input name="Submit1" style="width: 73px; height: 34px" type="button" value="OK" onclick="confirmation()"/><input name="ommit" style="width: 99px; height: 33px" type="button" value="OMISSIONS" onclick="omit()" />
