...
<html>
    ...
    <form name ="gui" method ="post" action="select-exercise.jsp">
        ...
        <p> <img style="Z-INDEX: 108; POSITION: absolute; TOP: 348px; LEFT: 312px" border=0 hspace=0 src="number/9.jpg" width=38 height=38 id="9" onclick="helperr(this.id)">
            <img style="Z-INDEX: 100; POSITION: absolute; TOP: 26px; LEFT: 864px" border=0 hspace=0 src="number/1.jpg" width=38 height=38 id="1" onclick="helperr(this.id)">
            <img style="Z-INDEX: 101; POSITION: absolute; TOP: 118px; LEFT: 902px" border=0 hspace=0 src="number/2.jpg" width=38 height=38 id="2" onclick="helperr(this.id)">
            <img style="Z-INDEX: 102; POSITION: absolute; TOP: 229px; LEFT: 919px" border=0 hspace=0 src="number/3.jpg" width=38 height=38 id="3" onclick="helperr(this.id)">
            <img style="Z-INDEX: 103; POSITION: absolute; TOP: 262px; LEFT: 835px" border=0 hspace=0 src="number/4.jpg" width=38 height=38 id="4" onclick="helperr(this.id)">
            <img style="Z-INDEX: 104; POSITION: absolute; TOP: 348px; LEFT: 863px" border=0 hspace=0 src="number/5.jpg" width=38 height=38 id="5" onclick="helperr(this.id)" >
            <img style="Z-INDEX: 105; POSITION: absolute; TOP: 499px; LEFT: 957px" border=0 hspace=0 src="number/6.jpg" width=38 height=38 id="6" onclick="helperr(this.id)">
            <img style="Z-INDEX: 106; POSITION: absolute; TOP: 508px; LEFT: 671px" border=0 hspace=0 src="number/7.jpg" width=38 height=38 id="7" onclick="helperr(this.id)">
            <img style="Z-INDEX: 107; POSITION: absolute; TOP: 506px; LEFT: 307px" border=0 hspace=0 src="number/8.jpg" width=38 height=38 id="8" onclick="helperr(this.id)">
            <img style="Z-INDEX: 109; POSITION: absolute; TOP: 266px; LEFT: 316px" border=0 hspace=0 src="number/10.jpg" width=38 height=38 id="10" onclick="helperr(this.id)">
            <img style="Z-INDEX: 110; POSITION: absolute; TOP: 156px; LEFT: 464px" border=0 hspace=0 src="number/11.jpg" width=38 height=38 id="11" onclick="helperr(this.id)">
            <img style="Z-INDEX: 111; POSITION: absolute; TOP: 321px; LEFT: 511px" border=0 hspace=0 src="number/12.jpg" width=38 height=38 id="12" onclick="helperr(this.id)">
            <img style="Z-INDEX: 112; POSITION: absolute; TOP: 286px; LEFT: 587px" border=0 hspace=0 src="number/13.jpg" width=38 height=38 id="13" onclick="helperr(this.id)">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 190px; LEFT: 564px" border=0 hspace=0 src="number/14.jpg" width=38 height=38 id="14" onclick="helperr(this.id)">
            <img style="Z-INDEX: 114; POSITION: absolute; TOP: 70px; LEFT: 636px" border=0 hspace=0 src="number/15.jpg" width=38 height=38 id="15" onclick="helperr(this.id)">
            <img style="Z-INDEX: 115; POSITION: absolute; TOP: 4px; LEFT: 746px" border=0 hspace=0 src="number/16.jpg" width=38 height=38 id="16" onclick="helperr(this.id)">
            <img style="Z-INDEX: 116; POSITION: absolute; TOP: 122px; LEFT: 733px" border=0 hspace=0 src="number/17.jpg" width=38 height=38 id="17" onclick="helperr(this.id)">
            <img style="Z-INDEX: 117; POSITION: absolute; TOP: 309px; LEFT: 727px" border=0 hspace=0 src="number/18.jpg" width=38 height=38 id="18" onclick="helperr(this.id)">
            <img style="Z-INDEX: 118; POSITION: absolute; TOP: 190px; LEFT: 775px" border=0 hspace=0 src="number/19.jpg" width=38 height=38 id="19" onclick="helperr(this.id)">
            <img style="Z-INDEX: 119; POSITION: absolute; TOP: 103px; LEFT: 853px" border=0 hspace=0 src="number/20.jpg" width=38 height=38 id="20" onclick="helperr(this.id)">
            <img style="Z-INDEX: 120; POSITION: absolute; TOP: 33px; LEFT: 815px" border=0 hspace=0 src="number/21.jpg" width=38 height=38 id="21" onclick="helperr(this.id)">
