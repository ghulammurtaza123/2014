...
<html>
    ...
    <form name ="gui" method ="post" action="select-exercise.jsp">
        ...
        <p> <img style="Z-INDEX: 108; POSITION: absolute; TOP: 483px; LEFT: 504px" id="9" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/I.jpg" width="39" height="35">
            <img style="Z-INDEX: 100; POSITION: absolute; TOP: 278px; LEFT: 205px" id="1" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/A.jpg" width="45" height="40">
            <img style="Z-INDEX: 101; POSITION: absolute; TOP: 102px; LEFT: 363px" id="2" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/B.jpg" width="41" height="43">
            <img style="Z-INDEX: 102; POSITION: absolute; TOP: 28px; LEFT: 554px" id="3" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/C.jpg" width="39" height="39">
            <img style="Z-INDEX: 103; POSITION: absolute; TOP: 29px; LEFT: 798px" id="4" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/D.jpg" width="36" height="35">
            <img style="Z-INDEX: 104; POSITION: absolute; TOP: 143px; LEFT: 991px" id="5" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/E.jpg" width="41" height="39" >
            <img style="Z-INDEX: 105; POSITION: absolute; TOP: 281px; LEFT: 1067px" id="6" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/F.jpg" width="37" height="38">
            <img style="Z-INDEX: 106; POSITION: absolute; TOP: 415px; LEFT: 995px" id="7" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/G.jpg" width="35" height="35">
            <img style="Z-INDEX: 107; POSITION: absolute; TOP: 466px; LEFT: 793px" id="8" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/H.jpg" width="39" height="43">
            <img style="Z-INDEX: 109; POSITION: absolute; TOP: 391px; LEFT: 323px" id="10" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/J.jpg" width="31" height="35">
            <img style="Z-INDEX: 110; POSITION: absolute; TOP: 355px; LEFT: 230px" id="11" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/K.jpg" width="33" height="35">
            <img style="Z-INDEX: 111; POSITION: absolute; TOP: 85px; LEFT: 472px" id="12" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/L.jpg" width="33" height="41">
            <img style="Z-INDEX: 112; POSITION: absolute; TOP: 228px; LEFT: 506px" id="13" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/M.jpg" width="39" height="39">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 375px; LEFT: 701px" id="14" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/N.jpg" width="35" height="41"> 
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 206px; LEFT: 849px" id="15" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/O.jpg" width="35" height="41">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 44px; LEFT: 677px" id="16" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/P.jpg" width="35" height="41">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 144px; LEFT: 588px" id="17" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/Q.jpg" width="35" height="41">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 251px; LEFT: 629px" id="18" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/R.jpg" width="35" height="41">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 238px; LEFT: 762px" id="19" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/S.jpg" width="35" height="41">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 116px; LEFT: 734px" id="20" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/T.jpg" width="35" height="41">&nbsp;&nbsp;
