...
<p> <img style="Z-INDEX: 108; POSITION: absolute; TOP: 103px; LEFT: 593px" id="9" onclick="helperr(this.id)" border="0" hspace="0" src="number/9.jpg" width="39" height="39">
    <img style="Z-INDEX: 120; POSITION: absolute; TOP: 448px; LEFT: 266px" id="1" onclick="helperr(this.id)" border="0" hspace="0" src="number/1.jpg" width="39" height="39">
   
    <img style="Z-INDEX: 101; POSITION: absolute; TOP:  457px; LEFT: 384px" id="2" onclick="helperr(this.id)" border="0" hspace="0" src="number/2.jpg" width="39" height="39">
    <img style="Z-INDEX: 102; POSITION: absolute; TOP: 366px; LEFT: 406px" id="3" onclick="helperr(this.id)" border="0" hspace="0" src="number/3.jpg" width="39" height="39">
    <img style="Z-INDEX: 103; POSITION: absolute; TOP: 281px; LEFT: 410px" id="4" onclick="helperr(this.id)" border="0" hspace="0" src="number/4.jpg" width="39" height="39">
    <img style="Z-INDEX: 104; POSITION: absolute; TOP: 180px; LEFT: 415px" id="5" onclick="helperr(this.id)" border="0" hspace="0" src="number/5.jpg" width="39" height="39">
    <img style="Z-INDEX: 105; POSITION: absolute; TOP: 89px; LEFT: 431px" id="6" onclick="helperr(this.id)" border="0" hspace="0" src="number/6.jpg" width="39" height="39">
    <img style="Z-INDEX: 106; POSITION: absolute; TOP: 17px; LEFT: 464px" id="7" onclick="helperr(this.id)" border="0" hspace="0" src="number/7.jpg" width="39" height="39">
    <img style="Z-INDEX: 107; POSITION: absolute; TOP: 19px; LEFT: 580px" id="8" onclick="helperr(this.id)" border="0" hspace="0" src="number/8.jpg" width="39" height="39">
    <img style="Z-INDEX: 109; POSITION: absolute; TOP: 188px; LEFT: 600px" id="10" onclick="helperr(this.id)" border="0" hspace="0" src="number/10.jpg" width="39" height="39">
    <img style="Z-INDEX: 110; POSITION: absolute; TOP: 284px; LEFT: 597px" id="11" onclick="helperr(this.id)" border="0" hspace="0" src="number/11.jpg" width="39" height="39">
    <img style="Z-INDEX: 111; POSITION: absolute; TOP: 374px; LEFT: 595px" id="12" onclick="helperr(this.id)" border="0" hspace="0" src="number/12.jpg" width="39" height="39">
    <img style="Z-INDEX: 112; POSITION: absolute; TOP: 443px; LEFT: 587px" id="13" onclick="helperr(this.id)" border="0" hspace="0" src="number/13.jpg" width="39" height="39">
    <img style="Z-INDEX: 115; POSITION: absolute; TOP: 445px; LEFT: 683px" id="14" onclick="helperr(this.id)" border="0" hspace="0" src="number/14.jpg" width="39" height="39"> 
    <img style="Z-INDEX: 114; POSITION: absolute; TOP: 437px; LEFT: 775px" id="15" onclick="helperr(this.id)" border="0" hspace="0" src="number/15.jpg" width="39" height="39">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
function confirmation(){
   ...
   var answer=confirm("Do you want to skip remaining exercise");
    ...
    document.body.background="pisa2.jpg";
    ask();
