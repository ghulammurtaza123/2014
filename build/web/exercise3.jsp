...
//String old_Wrong[]=new String[];
        ...
        try {
            ...
            rs2.updateString("exercise", "Exercise#2b");
...
//System.out.println("four"+four[1]);
            switch (four[1]) {
                case 1:
 ...
 sexta = listy[15].toCharArray();*/
    ...
    <form name ="gui" method ="post" action="exercise4.jsp">
        <center>
            <BR>
            <BR>
            <BR>
       ...
       //-->
        ...
        <script type="text/javascript">
            ...
            function confirmation() {
                ...
                /* if(correctwrd>=wrongee){
                 correctwrd=correctwrd-wrongee;}
                 else{
                 correctwrd=wrongee-correctwrd;
                 correctwrd=7-correctwrd;
                 
                 wrongwrd=(7-correctwrd);*/
                time = document.gui.secchar.value;
                ...
                document.gui.crct.value = correctwrd;
                document.gui.wrongs.value = wrongee;

                //alert(" Your score for this excercise ?\n  Correctly Match: "+correctwrd+"\n  Wrong : "+wrongee+"\n  Time: "+ time+"sec")
                window.location.href('exercise4.jsp?wrong[]=' + [omissions, wrongee, time]);
        ...
        <input name="secchar"  class="style12" style="width: 112px; height: 24px" type="text" class="style12" id="timer" name="timee" onkeypress="return false;
        ...
        <br /><input name="thechar" class="style12" style="width: 112px; height: 24px" type="text"  /><br /><input name="sec" class="style12" style="width: 112px; height: 24px" type="text" /><br /><input name="tre" class="style12" style="width: 112px; height: 24px" type="text" />
        <br /><input name="crct" style="width: 112px; height: 24px" type="text" class="style12" /><br /><input name="wrongs" style="width: 112px; height: 24px" type="text" class="style12" /><br /></form>
