...
javascript:window.history.forward(1);
        ...
        function Column(e) {        //Return the selected column index
            var ColNum=1;
...
String user="re";
        ...
        case 1:%>
            <table cellpadding="0" cellspacing="0" class="style4" style="width: 645px; height: 309px" align="center" id="fir"  >
                ...
                <tr id="tr1" onclick="rindex(this)">
                    ...
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data2(this,this.id)" id="35">O</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data2(this,this.id)" id="36">L</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data2(this,this.id)" id="37">V</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data2(this,this.id)" id="38">K</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data2(this,this.id)" id="39">F</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data2(this,this.id)" id="40">R</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data2(this,this.id)" id="41">P</td>
    ...
    case 2:%>
            <table cellpadding="0" cellspacing="0" class="style4" style="width: 645px; height: 309px" align="center" id="fir"  >
                <tr id="tr0" onclick="rindex(this)">
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data0(this,this.id)" id="20">P</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data0(this,this.id)" id="21"><%= four[0]%></td>
    ...
    case 3:%>
            <table cellpadding="0" cellspacing="0" class="style4" style="width: 645px; height: 309px" align="center" id="fir"  >
                ...
                <tr id="tr11" onclick="rindex(this)">
                    ...
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data22(this,this.id)" id="161"><%= nine[5]%></td>
                    <td style="height: 43px; width: 41px;" rowspan="2" class="style11" onclick="data22(this,this.id)" id="162"><%= eight[5
                            ]%></td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data22(this,this.id)" id="163"><%= sec[0]%></td>
                    <td style="width: 25%; height: 1px" class="style6" onclick="message11(this,this.id)" id="19" onmouseover=" this.bgColor='#FAEBD7'" onmouseout=" this.bgColor=''" ><strong><%= listy[11]%></strong></td>
                </tr>
            ...
            <table cellpadding="0" cellspacing="0" class="style4" style="width: 645px; height: 309px" align="center" id="fir"  >
                ...
                <tr id="tr1" onclick="rindex(this)">
                    ...
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data2(this,this.id)" id="41">O</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data2(this,this.id)" id="42">G</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data2(this,this.id)" id="43">T</td>
                    <td style="width: 25%; height: 1px" class="style6" onclick="message1(this,this.id)" id="9" onmouseover=" this.bgColor='#FAEBD7'" onmouseout=" this.bgColor=''" ><strong><%= listy[1]%></strong></td>
                </tr>
                <tr>
                    <td style="width: 25%; height: 0px" class="style6"></td>
                ...
                <tr id="tr2" onclick="rindex(this)">
                    ...
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data4(this,this.id)" id="47">T</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data4(this,this.id)" id="48">P</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data4(this,this.id)" id="49">S</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data4(this,this.id)" id="50">J</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data4(this,this.id)" id="51">I</td>
                ...
                <tr id="tr5" onclick="rindex(this)">
                    ...
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data10(this,this.id)" id="82">M</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data10(this,this.id)" id="83">F</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data10(this,this.id)" id="84">E</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data10(this,this.id)" id="85"><%= five[0]%></td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data10(this,this.id)" id="86">I</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data10(this,this.id)" id="87">Q</td>
                    <td style="width: 41px;height: 43px" rowspan="2" class="style11" onclick="data10(this,this.id)" id="88"><%= sec[2]%></td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data10(this,this.id)" id="89"><%= first[0]%></td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data10(this,this.id)" id="90">Z</td>
                ...
                <tr id="tr11" onclick="rindex(this)">
                    ...
                    <td style=" width: 41px; height: 43px" rowspan="2" class="style11" onclick="data22(this,this.id)" id="159">T</td>
                    <td style="width: 41px;  height: 43px" rowspan="2" class="style11" onclick="data22(this,this.id)" id="160">C</td>
                    <td style="width: 41px; height: 43px" rowspan="2" class="style11" onclick="data22(this,this.id)" id="161">F</td>
                    <td style="height: 43px; width: 41px;" rowspan="2" class="style11" onclick="data22(this,this.id)" id="162">U</td>
...
recorder[rank]=arr[rowno][right];
    ...
    x[init]= (recorder[init+1])-(recorder[init]);}
     ...
     if(correct==(len) && choice==1 && seq==(len-3) && noseq<=1 )  {
        ...
        <br /><input name="secchar"  class="style12" style="width: 112px; height: 24px" type="text"  id="timer" onkeypress="return false ; " value=" "/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" class="style12" value="Reload Page" name ="button3">
