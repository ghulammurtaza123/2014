...
<html>
    ...
    <form name ="gui" method ="post" action="select-exercise.jsp">
        ...
        <p> <img style="Z-INDEX: 108; POSITION: absolute; TOP: 168px; LEFT: 471px" id="9" onclick="helperr(this.id)" border="0" hspace="0" src="number/9.jpg" width="39" height="39">
            <img style="Z-INDEX: 120; POSITION: absolute; TOP: 467px; LEFT: 568px" id="1" onclick="helperr(this.id)" border="0" hspace="0" src="number/1.jpg" width="39" height="39">

            <img style="Z-INDEX: 101; POSITION: absolute; TOP:  367px; LEFT: 576px" id="2" onclick="helperr(this.id)" border="0" hspace="0" src="number/2.jpg" width="39" height="39">
            <img style="Z-INDEX: 102; POSITION: absolute; TOP: 264px; LEFT: 583px" id="3" onclick="helperr(this.id)" border="0" hspace="0" src="number/3.jpg" width="39" height="39">
            <img style="Z-INDEX: 103; POSITION: absolute; TOP: 213px; LEFT: 516px" id="4" onclick="helperr(this.id)" border="0" hspace="0" src="number/4.jpg" width="39" height="39">
            <img style="Z-INDEX: 104; POSITION: absolute; TOP: 278px; LEFT: 520px" id="5" onclick="helperr(this.id)" border="0" hspace="0" src="number/5.jpg" width="39" height="39" >
            <img style="Z-INDEX: 105; POSITION: absolute; TOP: 218px; LEFT: 453px" id="6" onclick="helperr(this.id)" border="0" hspace="0" src="number/6.jpg" width="39" height="39">
            <img style="Z-INDEX: 106; POSITION: absolute; TOP: 300px; LEFT: 441px" id="7" onclick="helperr(this.id)" border="0" hspace="0" src="number/7.jpg" width="39" height="39">
            <img style="Z-INDEX: 107; POSITION: absolute; TOP: 226px; LEFT: 372px" id="8" onclick="helperr(this.id)" border="0" hspace="0" src="number/8.jpg" width="39" height="39">
            <img style="Z-INDEX: 109; POSITION: absolute; TOP: 173px; LEFT: 346px" id="10" onclick="helperr(this.id)" border="0" hspace="0" src="number/10.jpg" width="39" height="39">
            <img style="Z-INDEX: 110; POSITION: absolute; TOP: 114px; LEFT: 361px" id="11" onclick="helperr(this.id)" border="0" hspace="0" src="number/11.jpg" width="39" height="39">
            <img style="Z-INDEX: 111; POSITION: absolute; TOP: 88px; LEFT: 438px" id="12" onclick="helperr(this.id)" border="0" hspace="0" src="number/12.jpg" width="39" height="39">
            <img style="Z-INDEX: 112; POSITION: absolute; TOP: 26px; LEFT: 510px" id="13" onclick="helperr(this.id)" border="0" hspace="0" src="number/13.jpg" width="39" height="39">
            <img style="Z-INDEX: 115; POSITION: absolute; TOP: 59px; LEFT: 586px" id="14" onclick="helperr(this.id)" border="0" hspace="0" src="number/14.jpg" width="39" height="39"> 
            <img style="Z-INDEX: 114; POSITION: absolute; TOP: 30px; LEFT: 679px" id="15" onclick="helperr(this.id)" border="0" hspace="0" src="number/15.jpg" width="39" height="39">
            <img style="Z-INDEX: 119; POSITION: absolute; TOP: 87px; LEFT: 752px" id="16" onclick ="helperr(this.id)" border=0" hspace="0" src="number/16.jpg" width="39" height="39">
            <img style="Z-INDEX: 116; POSITION: absolute; TOP: 118px; LEFT: 854px" id="17" onclick="helperr(this.id)" border="0" hspace="0" src="number/17.jpg" width="39" height="39">
            <img style="Z-INDEX: 117; POSITION: absolute; TOP: 209px; LEFT: 859px" id="18" onclick="helperr(this.id)" border="0" hspace="0" src="number/18.jpg" width="39" height="39">
            <img style="Z-INDEX: 118; POSITION: absolute; TOP: 139px; LEFT: 790px" id="19" onclick="helperr(this.id)" border="0" hspace="0" src="number/19.jpg" width="39" height="39">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 159px; LEFT: 702px" id="20" onclick="helperr(this.id)" border="0" hspace="0" src="number/20.jpg" width="39" height="39">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 199px; LEFT: 781px" id="21" onclick="helperr(this.id)" border="0" hspace="0" src="number/21.jpg" width="39" height="39">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 280px; LEFT: 803px" id="22" onclick="helperr(this.id)" border="0" hspace="0" src="number/22.jpg" width="39" height="39">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 230px; LEFT: 732px" id="23" onclick="helperr(this.id)" border="0" hspace="0" src="number/23.jpg" width="39" height="39">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 233px; LEFT: 646px" id="24" onclick="helperr(this.id)" border="0" hspace="0" src="number/24.jpg" width="39" height="39">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 322px; LEFT: 632px" id="25" onclick="helperr(this.id)" border="0" hspace="0" src="number/25.jpg" width="39" height="39">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 455px; LEFT: 630px" id="26" onclick="helperr(this.id)" border="0" hspace="0" src="number/26.jpg" width="39" height="39">&nbsp;&nbsp;
            ...
            function confirmation() {
                ...
                switch (select + 1) {
                    ...
                    case 6 :
                        ...
                        break;
                    default :
                        window.location.href('exercise2.jsp?wrong[]=' + [correctwrd, wrongwrd, time]);
                        break;
