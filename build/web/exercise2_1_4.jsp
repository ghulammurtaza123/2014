...
<p> <img style="Z-INDEX: 108; POSITION: absolute; TOP: 250px; LEFT: 608px" id="9" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/I.jpg" width="39" height="35">

    <img style="Z-INDEX: 120; POSITION: absolute; TOP: 183px; LEFT: 463px" id="1" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/A.jpg" width="45" height="40">
   
    <img style="Z-INDEX: 101; POSITION: absolute; TOP:  129px; LEFT: 629px" id="2" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/B.jpg" width =45 height=40>
    <img style="Z-INDEX: 102; POSITION: absolute; TOP: 55px; LEFT: 785px" id="3" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/C.jpg" width="39" height="39">
    <img style="Z-INDEX: 103; POSITION: absolute; TOP: 17px; LEFT: 859px" id="4" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/D.jpg" width="36" height="35">
    <img style="Z-INDEX: 104; POSITION: absolute; TOP: 18px; LEFT: 931px" id="5" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/E.jpg" width="41" height="39" >
    <img style="Z-INDEX: 105; POSITION: absolute; TOP: 89px; LEFT: 866px" id="6" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/F.jpg" width="37" height="38">
    <img style="Z-INDEX: 106; POSITION: absolute; TOP: 114px; LEFT: 780px" id="7" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/G.jpg" width="35" height="35">
    <img style="Z-INDEX: 107; POSITION: absolute; TOP: 222px; LEFT: 508px" id="8" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/H.jpg" width="39" height="43">
    <img style="Z-INDEX: 109; POSITION: absolute; TOP: 321px; LEFT: 560px" id="10" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/J.jpg" width="31" height="35">
    <img style="Z-INDEX: 110; POSITION: absolute; TOP: 376px; LEFT: 436px" id="11" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/K.jpg" width="33" height="35">
    <img style="Z-INDEX: 111; POSITION: absolute; TOP: 478px; LEFT: 302px" id="12" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/L.jpg" width="33" height="41">
    <img style="Z-INDEX: 112; POSITION: absolute; TOP: 498px; LEFT: 188px" id="13" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/M.jpg" width="39" height="39">
    <img style="Z-INDEX: 115; POSITION: absolute; TOP: 419px; LEFT: 112px" id="14" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/N.jpg" width="35" height="41"> 
    <img style="Z-INDEX: 114; POSITION: absolute; TOP: 292px; LEFT: 70px" id="15" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/O.jpg" width="35" height="41">
    <img style="Z-INDEX: 119; POSITION: absolute; TOP: 217px; LEFT: 179px" id="16" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/P.jpg" width="35" height="41">
    <img style="Z-INDEX: 116; POSITION: absolute; TOP: 183px; LEFT: 330px" id="17" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/Q.jpg" width="35" height="41">
    <img style="Z-INDEX: 117; POSITION: absolute; TOP: 141px; LEFT: 422px" id="18" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/R.jpg" width="35" height="41">
    <img style="Z-INDEX: 118; POSITION: absolute; TOP: 193px; LEFT: 414px" id="19" onclick="helperr(this.id)" border="0" hspace="0" src="ALPHABETS 2/S.jpg" width="35" height="41">&nbsp;&nbsp;&nbsp;
