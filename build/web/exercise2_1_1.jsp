...
<script type="text/JavaScript" src="jsDraw2D.js" ></script>
   ...
   <body background=" "  onload="Coords()"  style="overflow:hidden;position:relative;background-repeat:no-repeat;background-position:-374px -218px;" id="body1" >
...
PreparedStatement pStmt2 = conn.prepareStatement(sql2,ResultSet.TYPE_SCROLL_SENSITIVE, ResultSet.CONCUR_UPDATABLE);
...
<p> <img style="Z-INDEX: 108; POSITION: absolute; TOP: 144px; LEFT: 263px" border=0 hspace=0 src="ALPHABETS/I.jpg" width=39 height=35 id="9" onclick="helperr(this.id)">
    <img style="Z-INDEX: 100; POSITION: absolute; TOP: 31px; LEFT: 672px" border=0 hspace=0 src="ALPHABETS/A.jpg" width=45 height=40 id="1" onclick="helperr(this.id)">
    <img style="Z-INDEX: 101; POSITION: absolute; TOP: 31px; LEFT: 804px" border=0 hspace=0 src="ALPHABETS/B.jpg" width=41 height=43 id="2" onclick="helperr(this.id)">
    <img style="Z-INDEX: 102; POSITION: absolute; TOP: 59px; LEFT: 987px" border=0 hspace=0 src="ALPHABETS/C.jpg" width=39 height=39 id="3" onclick="helperr(this.id)">
    <img style="Z-INDEX: 103; POSITION: absolute; TOP: 143px; LEFT: 984px" border=0 hspace=0 src="ALPHABETS/D.jpg" width=36 height=35 id="4" onclick="helperr(this.id)">
    <img style="Z-INDEX: 104; POSITION: absolute; TOP: 141px; LEFT: 807px" border=0 hspace=0 src="ALPHABETS/E.jpg" width=41 height=39 id="5" onclick="helperr(this.id)" >
    <img style="Z-INDEX: 105; POSITION: absolute; TOP: 134px; LEFT: 676px" border=0 hspace=0 src="ALPHABETS/F.jpg" width=37 height=38 id="6" onclick="helperr(this.id)">
    <img style="Z-INDEX: 106; POSITION: absolute; TOP: 154px; LEFT: 528px" border=0 hspace=0 src="ALPHABETS/G.jpg" width=35 height=35 id="7" onclick="helperr(this.id)">
    <img style="Z-INDEX: 107; POSITION: absolute; TOP: 203px; LEFT: 293px" border=0 hspace=0 src="ALPHABETS/H.jpg" width=39 height=43 id="8" onclick="helperr(this.id)">
    <img style="Z-INDEX: 109; POSITION: absolute; TOP: 193px; LEFT: 421px" border=0 hspace=0 src="ALPHABETS/J.jpg" width=31 height=35 id="10" onclick="helperr(this.id)">
    <img style="Z-INDEX: 110; POSITION: absolute; TOP: 231px; LEFT: 587px" border=0 hspace=0 src="ALPHABETS/K.jpg" width=33 height=35 id="11" onclick="helperr(this.id)">
    <img style="Z-INDEX: 111; POSITION: absolute; TOP: 284px; LEFT: 590px" border=0 hspace=0 src="ALPHABETS/L.jpg" width=33 height=41 id="12" onclick="helperr(this.id)">
    <img style="Z-INDEX: 112; POSITION: absolute; TOP: 221px; LEFT: 778px" border=0 hspace=0 src="ALPHABETS/M.jpg" width=39 height=39 id="13" onclick="helperr(this.id)">
    <img style="Z-INDEX: 113; POSITION: absolute; TOP: 194px; LEFT: 933px" border=0 hspace=0 src="ALPHABETS/N.jpg" width=35 height=41 id="14" onclick="helperr(this.id)">
    <img style="Z-INDEX: 114; POSITION: absolute; TOP: 239px; LEFT: 969px" border=0 hspace=0 src="ALPHABETS/O.jpg" width=35 height=36 id="15" onclick="helperr(this.id)">
    <img style="Z-INDEX: 115; POSITION: absolute; TOP: 348px; LEFT: 972px" border=0 hspace=0 src="ALPHABETS/P.jpg" width=35 height=38 id="16" onclick="helperr(this.id)">
    <img style="Z-INDEX: 116; POSITION: absolute; TOP: 271px; LEFT: 918px" border=0 hspace=0 src="ALPHABETS/Q.jpg" width=41 height=43 id="17" onclick="helperr(this.id)">
    <img style="Z-INDEX: 117; POSITION: absolute; TOP: 293px; LEFT: 793px" border=0 hspace=0 src="ALPHABETS/R.jpg" width=41 height=41 id="18" onclick="helperr(this.id)">
    <img style="Z-INDEX: 118; POSITION: absolute; TOP: 350px; LEFT: 612px" border=0 hspace=0 src="ALPHABETS/S.jpg" width=36 height=41 id="19" onclick="helperr(this.id)">
    <img style="Z-INDEX: 119; POSITION: absolute; TOP: 467px; LEFT: 577px" border=0 hspace=0 src="ALPHABETS/T.jpg" width=37 height=45 id="20" onclick="helperr(this.id)">
    <img style="Z-INDEX: 120; POSITION: absolute; TOP: 348px; LEFT: 531px" border=0 hspace=0 src="ALPHABETS/U.jpg" width=37 height=39 id="21" onclick="helperr(this.id)">
    <img style="Z-INDEX: 121; POSITION: absolute; TOP: 304px; LEFT: 427px" border=0 hspace=0 src="ALPHABETS/V.jpg" width=39 height=41 id="22" onclick="helperr(this.id)">
    <img style="Z-INDEX: 122; POSITION: absolute; TOP: 278px; LEFT: 290px" border=0 hspace=0 src="ALPHABETS/W.jpg" width=40 height=43 id="23" onclick="helperr(this.id)">
    <img style="Z-INDEX: 123; POSITION: absolute; TOP: 363px; LEFT: 284px" border=0 hspace=0 src="ALPHABETS/X.jpg" width=37 height=39 id="24" onclick="helperr(this.id)">
    &nbsp; 
</p>
...
seq[5]=5;
          ...
          case '24':
              ...
              if((oldmem=='23')&&(val==total)){
                  
                ctx.clearRect(0, 0, canvas.width, canvas.height);
              document.body.background="data/exercise_2/bedd.jpg";
