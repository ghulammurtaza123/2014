...
<html>
    ...
    <form name ="gui" method ="post" action="select-exercise.jsp">
        ...
        <p> <img style="Z-INDEX: 108; POSITION: absolute; TOP: 144px; LEFT: 263px" border=0 hspace=0 src="number/9.jpg" width=38 height=35 id="9" onclick="helperr(this.id)">
            <img style="Z-INDEX: 100; POSITION: absolute; TOP: 31px; LEFT: 672px" border=0 hspace=0 src="number/1.jpg" width=38 height=38 id="1" onclick="helperr(this.id)">
            <img style="Z-INDEX: 101; POSITION: absolute; TOP: 31px; LEFT: 804px" border=0 hspace=0 src="number/2.jpg" width=38 height=38 id="2" onclick="helperr(this.id)">
            <img style="Z-INDEX: 102; POSITION: absolute; TOP: 59px; LEFT: 987px" border=0 hspace=0 src="number/3.jpg" width=38 height=39 id="3" onclick="helperr(this.id)">
            <img style="Z-INDEX: 103; POSITION: absolute; TOP: 143px; LEFT: 984px" border=0 hspace=0 src="number/4.jpg" width=36 height=38 id="4" onclick="helperr(this.id)">
            <img style="Z-INDEX: 104; POSITION: absolute; TOP: 141px; LEFT: 807px" border=0 hspace=0 src="number/5.jpg" width=38 height=39 id="5" onclick="helperr(this.id)" >
            <img style="Z-INDEX: 105; POSITION: absolute; TOP: 134px; LEFT: 676px" border=0 hspace=0 src="number/6.jpg" width=37 height=38 id="6" onclick="helperr(this.id)">
            <img style="Z-INDEX: 106; POSITION: absolute; TOP: 154px; LEFT: 528px" border=0 hspace=0 src="number/7.jpg" width=38 height=38 id="7" onclick="helperr(this.id)">
            <img style="Z-INDEX: 107; POSITION: absolute; TOP: 203px; LEFT: 293px" border=0 hspace=0 src="number/8.jpg" width=39 height=38 id="8" onclick="helperr(this.id)">
            <img style="Z-INDEX: 109; POSITION: absolute; TOP: 193px; LEFT: 421px" border=0 hspace=0 src="number/10.jpg" width=38 height=35 id="10" onclick="helperr(this.id)">
            <img style="Z-INDEX: 110; POSITION: absolute; TOP: 231px; LEFT: 587px" border=0 hspace=0 src="number/11.jpg" width=38 height=35 id="11" onclick="helperr(this.id)">
            <img style="Z-INDEX: 111; POSITION: absolute; TOP: 284px; LEFT: 590px" border=0 hspace=0 src="number/12.jpg" width=38 height=38 id="12" onclick="helperr(this.id)">
            <img style="Z-INDEX: 112; POSITION: absolute; TOP: 221px; LEFT: 778px" border=0 hspace=0 src="number/13.jpg" width=39 height=39 id="13" onclick="helperr(this.id)">
            <img style="Z-INDEX: 113; POSITION: absolute; TOP: 194px; LEFT: 933px" border=0 hspace=0 src="number/14.jpg" width=38 height=38 id="14" onclick="helperr(this.id)">
            <img style="Z-INDEX: 114; POSITION: absolute; TOP: 239px; LEFT: 969px" border=0 hspace=0 src="number/15.jpg" width=38 height=36 id="15" onclick="helperr(this.id)">
            <img style="Z-INDEX: 115; POSITION: absolute; TOP: 348px; LEFT: 972px" border=0 hspace=0 src="number/16.jpg" width=38 height=38 id="16" onclick="helperr(this.id)">
            <img style="Z-INDEX: 116; POSITION: absolute; TOP: 271px; LEFT: 918px" border=0 hspace=0 src="number/17.jpg" width=38 height=38 id="17" onclick="helperr(this.id)">
            <img style="Z-INDEX: 117; POSITION: absolute; TOP: 293px; LEFT: 793px" border=0 hspace=0 src="number/18.jpg" width=38 height=38 id="18" onclick="helperr(this.id)">
            <img style="Z-INDEX: 118; POSITION: absolute; TOP: 350px; LEFT: 612px" border=0 hspace=0 src="number/19.jpg" width=36 height=38 id="19" onclick="helperr(this.id)">
            <img style="Z-INDEX: 119; POSITION: absolute; TOP: 467px; LEFT: 577px" border=0 hspace=0 src="number/20.jpg" width=37 height=38 id="20" onclick="helperr(this.id)">
            <img style="Z-INDEX: 120; POSITION: absolute; TOP: 348px; LEFT: 531px" border=0 hspace=0 src="number/21.jpg" width=37 height=39 id="21" onclick="helperr(this.id)">
            <img style="Z-INDEX: 121; POSITION: absolute; TOP: 304px; LEFT: 427px" border=0 hspace=0 src="number/22.jpg" width=39 height=38 id="22" onclick="helperr(this.id)">
            <img style="Z-INDEX: 122; POSITION: absolute; TOP: 278px; LEFT: 290px" border=0 hspace=0 src="number/23.jpg" width=38 height=38 id="23" onclick="helperr(this.id)">
            <img style="Z-INDEX: 123; POSITION: absolute; TOP: 363px; LEFT: 284px" border=0 hspace=0 src="number/24.jpg" width=37 height=39 id="24" onclick="helperr(this.id)">
            &nbsp; 
        </p>
