...
<body background="nat.jpg" onload="swdStart('timer', 1)"  >
    ...
    <form name ="gui" method ="post" action="exercise5.jsp">
        ...
        <TABLE background="white" cellspacing="5" border="2" class="style4" align="center" name="mem">
            ...
            <TR>
                ...
                <TD class="style12"></TD>
                <TD class="style12"></TD>
                <TD><IMG src=<%=temp4%> width="100" height="100" id="40" onclick="data1(this.id, this.name)" name=<%=values[3]%>></TD>
                <TD class="style12"></TD>
            </TR><TR>
        ...
        <script type="text/javascript">
            ...
            <%
                ...
                //String urle = "jdbc:odbc:worddsn";
                String sql2 = "SELECT * FROM " + name;
                // Connection conn = DriverManager.getConnection(urle);
                ...
                rs2.updateString("exercise", "Exercise#3");
            ...
            function confirmation() {
                ...
                window.location.href('exercise5.jsp?wrong[]=' + [correctwrd, wrongee, time]);
                //}
                // alert(" Your score for this excercise ?\n  No.of tries: "+counter+"\n  Wrong : "+wrongee+"\n  Time: "+ time+"sec");
                //document.gui.button2.click();

                //  if (confirm("Congrats!Do you want to continue?")) {
